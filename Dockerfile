...
RUN dotnet restore Dysnomia.HowToOpenMe.sln --ignore-failed-sources /p:EnableDefaultItems=false
RUN dotnet publish Dysnomia.HowToOpenMe.sln --no-restore -c Release -o out
